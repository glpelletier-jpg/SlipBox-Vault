...
**Current state:** ~150 fleeting · 49 literature · 28 permanent · 8 MOCs
...
**File naming convention:** Use the "PN — [Full claim title]" format already in use:
`PN — Flow requires challenge calibrated just above current skill.md`
...
**Method 1 — Hotkey:**
Press `Ctrl+Shift+P`. A new note is created in `06-Zettelkasten/Permanent/`. The first thing you do is press `F2` and rename it to "PN — [claim]". Do this immediately — before you write anything.
...
```
- [[PN — name-of-other-permanent-note]] — *because (state the relationship)*
- [[PN — another-permanent-note]] — *contrasts with / extends / supports*
```
...
**How:**
1. `Ctrl+P` → "QuickAdd: New MOC" OR create a note in `06-Zettelkasten/MOC/`
2. Name it: "MOC — Theme Name" (e.g., "MOC — Automation Engineering")
...
- [[06-Zettelkasten/MOC/MOC — Instrumentation|MOC — Instrumentation]]
- [[06-Zettelkasten/MOC/MOC — OT Networking|MOC — OT Networking]]
- [[06-Zettelkasten/MOC/MOC — PLC Architecture|MOC — PLC Architecture]]
- [[06-Zettelkasten/MOC/MOC — Process Safety|MOC — Process Safety]]
...
The vault currently has 28 permanent notes (6 original + 22 IA/OT stubs). The target is 50 by end of Q3. The Literature Processing Guide has the material — the work is just writing.
...
The vault has ~150 fleeting notes. Collecting is comfortable. Processing is uncomfortable. The Zettelkasten only works if processing happens.
