// Next Week Calendar — fetches Google Calendar via ICS URL (next week)
// Ctrl+Shift+J → next week | Ctrl+Shift+K → this week (weekly-calendar.js)

const CONFIG = {
  name: "Next Week Calendar",
  author: "Slip Box",
  options: {
    ics_url: {
      type: "input",
...
module.exports = async (params, settings) => {
  await runCalendar(params, settings, 1);
};
