...
date: 2026-05-31
type: fleeting
tags: [fleeting, PKM, learning, insight]
---
...
![Untitled](https://cdn-images-1.medium.com/max/800/1*8HdP01p4Q5qgh8LKBVT3FA.png)
[Untitled - Notes](../Images/Untitled%20(50).md)

[Available here](https://arxiv.org/abs/0812.4360)
...
- You know traffic patterns fluctuate, but your brain makes you curious about whether there is an easy-to-remember pattern

- You know the sky is usually blue, but not always, and the brain wants a simple rule to know what to expect
...
- Traffic is worse during rush hour when people are traveling to and from work, which tends to be in the morning and late afternoon

- The sky is always blue due to its chemical makeup, but can often be obscured by clouds, or darkened at nighttime

- People react negatively when I talk about my accomplishments because they think I’m bragging, which implies I think I’m better than them

All these are rules or patterns we learned first as children, which got progressively refined as we grew older and wiser.

The brain rewards compression progress with *interestingness* — defined as the steepness of the learning curve from the previous rule to the new one. You learn as a baby that things fall when you drop them. The discovery of the phenomenon of gravity, which helps explain a wide range of things, a baby finds tremendously *interesting* (thus all the objects they try dropping to test their new theory).
...
What you find when you look out on the world is compression everywhere. Communication is compression, packaging up tangled thoughts into neat little words with agreed-upon meanings. Love is compression, fusing a series of experiences, memories, feelings, and thoughts into an exhilarating state of mind. Supply chains are compression, adding value at each stage and refining the product into the most elegant expression of utility possible.

And as we’ve discussed, note-taking in all its forms is compression. Let me show you some examples from other media.

### Picasso’s Bull

![Untitled](https://cdn-images-1.medium.com/max/800/1*kgHSKkYfLQkF6TcmMMVHsA.jpeg)
[Untitled - Notes](../Images/Untitled%20(51).md)

One of the most [famous and clear examples](http://www.artyfactory.com/art_appreciation/animals_in_art/pablo_picasso.htm) of compression is Picasso’s Bull, which he painted in a series of 11 lithographs in 1945. His goal, it seems, was to find the “essence” of the beast in a series of progressively simpler images.
...
Ten years earlier Picasso had said “A picture used to be a sum of additions. In my case a picture is a sum of destructions.” We see this at work here, as he starts to erase sections of the bull to redistribute the balance between the front and rear. By enlarging the eye and flattening its horns, for example, he moves the focal point to the front of the animal.
...
But what’s critical for us to understand is that *each of the stages was still necessary*. Each step contained its own discoveries, its own lessons, its own mistakes. He could have gotten discouraged, or taken a break to work on his art certification, or gone back to “perfect” his first try. But he took a different path — creative destruction. Breaking down, then building up. Diverging, then converging. Compressing, then decompressing.
...
One of the participants in my online course [Building a Second Brain](http://www.buildingasecondbrain.com/), from which this series is drawn, applied P.S. to music. Here’s the layers (or stages) he came up with:

![Untitled](https://cdn-images-1.medium.com/max/800/1*YlEtSnyAcVf9jeJJoqSEAA.png)
[Untitled - Notes](../Images/Untitled%20(52).md)
...
### Progressive Summarization in a tweetstorm

Here’s a final example that’s more feasible for anyone to try. It comes from a tweetstorm (a series of threaded tweets on a topic, on Twitter) I came across one day.

Nicholas hasn’t taken my course, but I could see the progressive layers:

![Untitled](https://cdn-images-1.medium.com/max/800/1*eHanZXVU2Jgw9t2PRw-tsw.jpeg)
[Untitled - Notes](../Images/Untitled%20(53).md)

Layer 0 is the original source, which is linked to at the end of the thread. Layer 1 is the screenshot he took and attached to his tweet. Layer 2 is the section he highlighted. And Layer 3 is the body of the tweet, where he paraphrased one idea to further emphasize it.
...
From my perspective, this is a service to humanity. I’m not forced to make an all-or-nothing decision to read the whole source, or nothing at all. He’s not teasing me with a comment like “What a great article!”, only for me to discover 20 minutes in that it has no relevance to me. He’s making use of the precious attention he’s spending reading and taking notes, to also make those notes more accessible to me as a prospective reader.
...
- [Mindgym Performance Mgmt notes](https://www.evernote.com/l/AMwcK2OGYBhI0pwTXGSidSyyleY8ZLrC96U) (**white paper**)

- [Psychological Capital paper notes](https://www.evernote.com/l/AMxmlT5g8WBHjYUGBpVe6BQ3rDIvK_YmLSM) (**academic paper PDF**)

- [Google Uses Structured Interviews to Improve the Hiring Process and Retention Rates](https://www.evernote.com/l/AMxiNqFJCsNMb4AqhEz_Lc1zZN6WA40hPkI) (**online article**)

- [Critical Chain PM podcast](https://www.evernote.com/l/AMxtDZv8rGlKNoCOzsQaRNRntg5OuoyPOI0) (**podcast**)

- [Toyota Kata notes](https://www.evernote.com/l/AMw2lidTDLxEXYHI1ouacvbRSrjMV9v61eM) (**book**)

- [Premature Synchronization is the Root of All Evil](https://www.evernote.com/l/AMwl48b_ru9PnKBF71-aspY5AHvzd16R0sk) (**tweetstorm**)

- [Baumol’s cost disease](https://www.evernote.com/l/AMzYzFc1-cVKLq4mh-jLtxomeHsmSUVsMo0) (**Wikipedia article**)

- [Notes on Demistifying the MOOC (NYT)](https://www.evernote.com/l/AMw3hNllTP5JnLXBW9UQcPQTdg0raJlgBtA) (**New York Times article**)

- [Habit Mapping](https://www.evernote.com/l/AMyF9cZkmJdOXJ6PXCiGiLJr7jzE7fkOufs) (**paper notebook**)

- [DOES San Francisco 2016 w/ John Willis notes](https://www.evernote.com/l/AMyHJhC_EhVLI7jewz8Mt7xY3kwj_p5Siks) (**YouTube video**)

- [Good Strategy, Bad Strategy notes](https://www.evernote.com/l/AMzHR80GoglDqLI6SLvxpgLK1OVscCWN78E) (**audiobook**)

- [Giles Bowkett: Why Scrum Should Basically Just Die In A Fire](https://www.evernote.com/l/AMzYExhK8HZBD7j7lXOi70F6sZpey0O_-Vk) (**blog post**)

- [Kirkpatrick’s Four-Level Training Evaluation Model — MindTools.com](https://www.evernote.com/l/AMxIe39rywdE_6XSk6fJPT4zrbzwGle07fY) (**output from** [Liner app](http://getliner.com/))

- [Stratechery: Jeff Bezos’ Annual Letter, Facebook Messenger and Payments, Facebook Instant Articles Fizzing?](https://www.evernote.com/l/AMzKp-JOeLFLj5qU53UNUiHIC350eCCq6zM) (**email**)
