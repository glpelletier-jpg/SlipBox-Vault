...
date: 2026-05-31
type: fleeting
tags: [fleeting, learning, PKM, insight]
---

# Progressive Summarization V: The Faster You Forget, The Faster You Learn

In [Part I](https://fortelabs.com/progressive-summarization-a-practical-technique-for-designing-discoverable-notes-3459b257d3eb), I introduced Progressive Summarization, a method for easily creating highly discoverable notes. In [Part II](https://fortelabs.com/progressive-summarization-ii-examples-and-metaphors-5f9b8b7108df), I gave you examples and metaphors of the method in action. [Part III](https://fortelabs.com/progressive-summarization-iii-guidelines-and-principles-1466e29fea80) included my top recommendations for how to perform it effectively. [Part IV](https://fortelabs.com/progressive-summarization-iv-compressing-all-types-of-media-4dff7f6f27e8) showed how to apply the technique to non-text media.
...
This [New York Times article](https://www.theguardian.com/science/2017/feb/08/total-recall-the-people-who-never-forget) tells the fascinating story of the 60 or so people known to have a condition called **Highly Superior Autobiographical Memory (HSAM)**. They can remember most of the days of their lives as clearly as the rest of us remember yesterday. Ask one of them what they were doing on the afternoon of March 16, 1996, and within just a few seconds they’ll be able to describe that day in vivid detail.
...
This leads to techniques like [spritzing](http://spritzinc.com/), listening to audiobooks on 2x speed, speed reading, focusing on already highly condensed sources, blocking distractions, deep focus, and biaural beats.
...
Contrast this dim view of perfect memory with [this article on new deep learning techniques](http://ift.tt/2xkeBN8) in artificial intelligence. Specifically, a new theory called the “information bottleneck.”
...
[This blog post](http://thankyoubrain.blogspot.ca/2017/02/managing-information-to-be-remembered.html) describes recent research on what is known as “proactive inhibition of memory formation.” Offloading our thinking to an external tool lowers the brain’s workload as it encounters new information. In the experiments above, telling participants they didn’t have to remember a list of items enhanced their memory for a second list of items.
...
![Untitled](https://cdn-images-1.medium.com/max/800/1*oXLOqgF0MoEks7cFwuyPxQ.png)
[Untitled - Notes](../Images/Untitled%20(54).md)
