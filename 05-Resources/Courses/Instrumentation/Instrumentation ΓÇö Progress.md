...
target_score: 75%
exam_date:
tags: [course, courses, progress, ia-ot, instrumentation, cap]
---
...
const hrs = Math.floor(totalMin / 60), mins = totalMin % 60, estHrs = 45;
...
WHERE contains(moc, "[[06-Zettelkasten/MOC/MOC — Instrumentation]]")
SORT created ASC
```
...
### Module 5 — Level, Pressure, Temperature
-

### Module 6 — SICK Sensors
-

### Module 7 — SIL Instruments
-
...
**Links:** [[05-Resources/Courses/Instrumentation/Instrumentation — Overview|Overview]] · [[05-Resources/Courses/Instrumentation/Instrumentation — Syllabus|Syllabus]] · [[05-Resources/Courses/Instrumentation/Instrumentation — Reference|Quick Reference]]
