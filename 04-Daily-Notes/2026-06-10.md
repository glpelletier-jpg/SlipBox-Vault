...
energy:
energy_score: "65"
focus_intention: Get work projects moving
end_of_day:
tags:
  - daily
---
...
- [x] `All day` — ✅ **Log focus sessions in daily note throughout day** ✅ 2026-06-10
- [x] `All day` — ✅ **🏃 Health Reset: Move for 30+ min** ✅ 2026-06-10
- [x] `All day` — ✅ **Morning routine: Morgen → Todoist → Obsidian daily note (15 min)** ✅ 2026-06-10
- [ ] `All day` — ✅ **Pack our clothes**
- [ ] `All day` — ✅ **House in order toliets cleaned**

---

**Today's focus:** *Get work projects moving*
...
- [duration:: 82]  Assign users new areas
...
- finally completed adding users, need to identify how the new user is to emulate by areas assigned
- 
