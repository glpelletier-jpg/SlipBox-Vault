...
- [ ] `All day` — ✅ **Add all electrical services to project list** 🆔 5MCfhQ
- [ ] `All day` — ✅ **Check on Athletico in a couple of days** 🆔 pSelpv
- [ ] `All day` — ✅ **Read G1A + G1B — frequency privileges and antenna rules** 🆔 EjhrGJ
- [ ] `All day` — ✅ **Make an eye appointment** 🆔 nHqRuO
- [ ] `All day` — ✅ **Make a dental appointment** 🆔 ugcrZO
- [ ] `All day` — ✅ **😴 Health Reset: In bed by target time** 🆔 m3FyWl
- [ ] `All day` — ✅ **Evening close: log vitals + energy + end-of-day note (8 min)** 🆔 Su0WrR
- [x] `All day` — ✅ **🥗 Health Reset: Avoid main dietary drain** ✅ 2026-06-08
- [ ] `All day` — ✅ **Rename permanent note 'Organizing my life.md' to a proper claim title** 🆔 t5tqAP
- [ ] `All day` — ✅ **Write permanent note from Feel Good Productivity — 'Physical energy is the multiplier on all other productive capacity'** 🆔 irIJDX
- [x] `All day` — ✅ **Assign Ctrl+Shift+M hotkey to Update Focus Minutes template** ✅ 2026-06-08
- [ ] `All day` — ✅ **Log focus sessions in daily note throughout day** 🆔 NThN62
- [ ] `All day` — ✅ **🏃 Health Reset: Move for 30+ min** 🆔 U1G6bL
- [ ] `All day` — ✅ **Morning routine: Morgen → Todoist → Obsidian daily note (15 min)** 🆔 aRaGO0
- [ ] `All day` — ✅ **Write 2 permanent notes from Tier 1 queue** 🆔 I2BR5T
- [ ] `All day` — ✅ **Start HAM Radio Week 1 — G1 Commission's Rules** 🆔 eogQow
- [ ] `All day` — ✅ **Ask HR about adding Rose life insurance** 🆔 QAVE8S
...
- [ ] 😴 In bed by target time 🆔 UVPMne
- [x] 🥗 Avoided main dietary drain ✅ 2026-06-08

**New Role Integration Q3**
- [ ] 📝 Captured one work observation, process note, or system detail 🆔 3a3zaO
- [x] 🤝 Connected with or followed up with a colleague ✅ 2026-06-08
- [ ] 🔧 Made progress on an open technical issue or task 🆔 BIvFpZ
